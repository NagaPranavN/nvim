...
require('lazy').setup({
...

  {
    ...
    config = function()
      local system_prompt =
        'You should replace the code/prompt that you are sent, only following the comments. Do not talk at all. Only output valid code/replies. Do not provide any backticks that surround the code/replies. Never ever output backticks like this ```. Any comment that is asking you for something should be removed after you satisfy them. Other comments should left alone. Do not output backticks.'
